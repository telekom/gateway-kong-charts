...
| kedaAutoscaling.triggers.prometheus.enabled | bool | `false` | Enable Prometheus/Victoria Metrics based scaling |
...
| pdb.unhealthyPodEvictionPolicy | string | `"AlwaysAllow"` | Policy for evicting unhealthy pods |
