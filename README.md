...
| `adminApi.ingress.hosts`                    | Set usual ingress array of hosts                                                                                           | `[{"host": "chart-example.local","paths": ["path": "/","pathType": "Prefix"]}]`      |
...
| `proxy.ingress.hosts`                       | Set usual ingress array of hosts                                                                                           | `[{"host": "chart-example.local","paths": ["path": "/","pathType": "Prefix"]}]`                                                                                |
